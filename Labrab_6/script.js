...
async function getProducts(page) {
    const url = `https://search.wb.ru/exactmatch/ru/common/v5/search?query=наушники&sort=price_desc&page=${page}&resultset=catalog&appType=1&curr=rub&dest=-1257786`;
